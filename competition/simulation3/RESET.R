...
Sigma = diag(rep(1,p))
amp = 25
settingName = "./results/simulation3"
...
savedir = paste(settingName,'/RESET_RF_',k,'_',as.character(ParamsRowIndex),'.csv',sep = "")
...
savedir = paste(settingName,'/RESET_NN_',k,'_',as.character(ParamsRowIndex),'.csv',sep = "")
write.csv(data.frame(fdp = fdp,power = power), savedir)
...
savedir = paste(settingName,'/RESET_GAM_',k,'_',as.character(ParamsRowIndex),'.csv',sep = "")
write.csv(data.frame(fdp = fdp,power = power), savedir)
...
savedir = paste(settingName,'/RESET_ensemble_',k,'_',as.character(ParamsRowIndex),'.csv',sep = "")
write.csv(data.frame(fdp = fdp,power = power), savedir)

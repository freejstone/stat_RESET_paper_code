...
settingName = "./results/simulation4"
...
savedir = paste(settingName,'/RESET_RF',dim_z,'_',n,'_',as.character(ParamsRowIndex),'.csv',sep = "")
...
savedir = paste(settingName,'/RESET_NN',dim_z,'_',n,'_',as.character(ParamsRowIndex),'.csv',sep = "")
write.csv(data.frame(fdp = fdp,power = power, time =time), savedir)
...
savedir = paste(settingName,'/RESET_GAM',dim_z,'_',n,'_',as.character(ParamsRowIndex),'.csv',sep = "")
write.csv(data.frame(fdp = fdp,power = power, time =time), savedir)
...
savedir = paste(settingName,'/RESET_ensemble',dim_z,'_',n,'_',as.character(ParamsRowIndex),'.csv',sep = "")
write.csv(data.frame(fdp = fdp,power = power, time =time), savedir)
